...
const CardField: React.FC<any> = ({ onChange }) => (
  <div className="style.FormRow">
    <CardElement options={CARD_OPTIONS} onChange={onChange} />
  </div>
);

const ResetButton: React.FC<any> = ({ onClick }) => (
  <button type="button" className="style.ResetButton" onClick={onClick}>
...
const Field: React.FC<any> = ({
  ...
  <div className="style.FormRow">
    <label htmlFor={id} className="style.FormRowLabel">
      {label}
    </label>
    <input
      className="style.FormRowInput"
      id={id}
      type={type}
...
const SubmitButton: React.FC<any> = ({ processing, error, children, disabled }) => (
  <button
    className={`style.SubmitButton ${error ? 'style.SubmitButton--error' : ''}`}
    type="submit"
...
const ErrorMessage: React.FC<any> = ({ children }) => (
  <div className="style.ErrorMessage" role="alert">
